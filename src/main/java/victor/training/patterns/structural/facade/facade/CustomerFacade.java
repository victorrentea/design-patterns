...
public class CustomerFacade {
	...
	public CustomerFacade(final CustomerRepository customerRepo, final EmailClient emailClient, final EmailRepository emailRepo, final SiteRepository siteRepo) {
